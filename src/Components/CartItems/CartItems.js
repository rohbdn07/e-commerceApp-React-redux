...
export default function CartItems() {
    ...
    console.log('the change amount it', price)
                                            ...
                                            <ul>
                                                <li>
                                                    <div className="add-minus-quantity">
                                                        <span><FaMinus onClick={() => minusQty(item)}/></span> 
                                                                <input type="text" value={item.qty} onChange={(e)=> e.target.value} placeholder='0' />
                                                        <span><FaPlus onClick={() => addQty(item)}/></span>
                                                    </div>
                                                </li>
                                            </ul>
                                    </div>
